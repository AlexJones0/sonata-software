...
DECLARE_AND_DEFINE_ALLOCATOR_CAPABILITY(__second_malloc_capability, MALLOC_QUOTA * 2)
DECLARE_AND_DEFINE_ALLOCATOR_CAPABILITY(__third_malloc_capability, MALLOC_QUOTA * 4)
DECLARE_AND_DEFINE_ALLOCATOR_CAPABILITY(__fourth_malloc_capability, MALLOC_QUOTA * 8)
DECLARE_AND_DEFINE_ALLOCATOR_CAPABILITY(__fifth_malloc_capability, MALLOC_QUOTA * 16)
...
/// Thread entry point.
[[noreturn]] void __cheri_compartment("mallocmulti") entry_point()
{
