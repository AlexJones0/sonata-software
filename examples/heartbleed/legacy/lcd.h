...
/**
 * @brief Formats and draws a string to the LCD display based upon the provided
 ...
 *
 * @param lcd a handle to the LCD to draw to.
 * @param x is the X-position of the top-left corner of the image on the LCD.
 * @param y is the Y-position of the top-left corner of the image on the LCD.
